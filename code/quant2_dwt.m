...
dwtstep_equal_mse = [
    [11.5984 7.5636 4.1248 2.1118 1.0623 1.1285]
    [11.5984 7.5636 4.1248 2.1118 1.0623 0]
    [8.3777 6.5318 3.7968 1.9788 1.0000 0]
    ];
...
for i=1:n
    ...
    for k=1:3
        ...
        Yq(tr,tc) = quant2(Y(tr,tc), dwtstep(k,i), 0.8*dwtstep(k,i));
...
tr = 1:w;
tc = 1:w;
Yq(tr,tc) = quant2(Y(tr,tc), dwtstep(1,n+1), 0.8*dwtstep(1,n+1));
